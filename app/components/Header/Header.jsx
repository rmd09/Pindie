    ...
    <header className={Styles["header"]}>
      ...
      <nav className={Styles["menu"]}>
        ...
        <div className={Styles["auth"]}>
          ...
          {authContext.isAuth && (
            <Link href="/profile" className={`${Styles["auth__button"]} ${Styles["profile__button"]}`}>
              <div className={`${Styles["auth__button__img"]} ${path === "/profile" && Styles["auth__button__img-hover"]}`} alt="profile"></div>
            </Link>
          )}
      ...
      <Popup isOpened={popupIsOpened} close={closePopup}>
        {isSignUp ? (
            <SignUp close={closePopup} login={login}/>
          ) : (
            <AuthForm close={closePopup} signUp={signUp}/>
        )}
      </Popup>
    </header>
  );
